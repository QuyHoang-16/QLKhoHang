...
using NetCore_Update.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Check if login failed due to unconfirmed email (development only)
                    ...
                    if (isDevelopment)
                    {
                        ...
                        {
                            // User exists and password is correct, but email might not be confirmed
                            if (!await _userManager.IsEmailConfirmedAsync(user))
                            {
                                ...
                                {
                                    _logger.LogInformation("Email auto-confirmed for existing user in development environment.");
                                    // Try login again after email confirmation
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Auto-confirm email in development environment
                    var env = HttpContext.RequestServices.GetService<IWebHostEnvironment>();
                    var isDevelopment = env?.IsDevelopment() ?? false;
                    ...
                    if (isDevelopment)
                    {
                        ...
                        if (confirmResult.Succeeded)
                        {
                            _logger.LogInformation("Email auto-confirmed for development environment.");
                            // Allow sign in after auto-confirmation in development

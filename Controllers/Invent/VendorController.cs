...
namespace QuanLyKho.Controllers.Invent
{
    ...
    public class VendorController : Controller
    {
        ...
        {
            return View(await _context.Vendors.OrderByDescending(x => x.createdAt).ToListAsync());
        }
        ...
        {
            var vendor = await _context.Vendors.Include(x => x.vendorLine).SingleOrDefaultAsync(m => m.vendorId == id);
            try
            {
                _context.VendorLines.RemoveRange(vendor.vendorLine);

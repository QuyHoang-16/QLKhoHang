...
namespace QuanLyKho.Controllers.Invent
{
    ...
    public class SalesOrderController : Controller
    {
        ...
        {
            SalesOrder obj = await _context.SalesOrders
        ...
        {
            var applicationDbContext = _context.SalesOrders.OrderByDescending(x => x.createdAt).Include(s => s.customer);
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var salesOrder = await _context.SalesOrders.Include(x => x.salesOrderLine).SingleOrDefaultAsync(m => m.salesOrderId == id);
            if (salesOrder == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            try
            {
                _context.SalesOrderLines.RemoveRange(salesOrder.salesOrderLine);

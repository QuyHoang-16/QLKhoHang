...
namespace QuanLyKho.Controllers.Invent
{
    ...
    public class TransferOrderController : Controller
    {
        ...
        {
            TransferOrder obj = await _context.TransferOrders
        ...
        public async Task<IActionResult> Index()
        {
            ...
            lists = await _context.TransferOrders.OrderByDescending(x => x.createdAt)
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var transferOrder = await _context.TransferOrders.SingleOrDefaultAsync(m => m.transferOrderId == id);
            if (transferOrder == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            try
            {
                _context.TransferOrderLines.RemoveRange(transferOrder.transferOrderLine);
        ...
        {
            return _context.TransferOrders.Any(e => e.transferOrderId == id);
        }

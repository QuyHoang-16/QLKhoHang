...
namespace NetCore_Update.Controllers.Invent
{
    ...
    public class PurchaseOrderController : Controller
    {
        ...
        {
            PurchaseOrder obj = await _context.PurchaseOrders
                .Include(x => x.vendor)
        ...
        {
            var applicationDbContext = _context.PurchaseOrders.OrderByDescending(x => x.createdAt).Include(p => p.vendor);
        ...
        public IActionResult Create()
        {
            ...
            Branch defaultBranch = _context.Branches.Where(x => x.isDefaultBranch.Equals(true)).FirstOrDefault();
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var purchaseOrder = await _context.PurchaseOrders.Include(x => x.purchaseOrderLine).SingleOrDefaultAsync(m => m.purchaseOrderId == id);
            if (purchaseOrder == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            try
            {
                _context.PurchaseOrderLines.RemoveRange(purchaseOrder.purchaseOrderLine);
